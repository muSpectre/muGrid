...
#ifndef SRC_COMMON_FIELD_COLLECTION_LOCAL_HH_
#define SRC_COMMON_FIELD_COLLECTION_LOCAL_HH_
...
namespace muSpectre {
   ...
   * forward declaration
   */
  template <Dim_t DimS> class GlobalFieldCollection;
  ...
  /* ---------------------------------------------------------------------- */
  template <Dim_t DimS> void LocalFieldCollection<DimS>::initialise() {
    if (this->is_initialised) {
...
#endif  // SRC_COMMON_FIELD_COLLECTION_LOCAL_HH_
