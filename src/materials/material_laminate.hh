 ...
 * @date   19 Oct 2018
 *
 * @brief  Defenition of MaterialLamiante class which is a lamiante approximation
 * constitutive law for two underlying materials with arbitrary constutive law
 *
