...
#ifndef SRC_LIBMUGRID_OPERATORS_SOLIDS_ISOTROPIC_STIFFNESS_OPERATOR_HH_
#define SRC_LIBMUGRID_OPERATORS_SOLIDS_ISOTROPIC_STIFFNESS_OPERATOR_HH_
...
namespace muGrid {
     ...
     * @brief Fused stiffness operator for 2D isotropic linear elastic materials.
     *
    ...
    namespace isotropic_stiffness_kernels {
         ...
         * @param nelx, nely Number of elements (= nnx for periodic, nnx-1 for non-periodic)
...
#endif  // SRC_LIBMUGRID_OPERATORS_SOLIDS_ISOTROPIC_STIFFNESS_OPERATOR_HH_
