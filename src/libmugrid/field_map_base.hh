...
namespace muGrid {
  ...
  namespace internal {
    ...
    class FieldMap<FieldCollection, T, NbComponents, ConstField>::iterator {
     ...
     public:
      ...
      using TypedMap_t = std::conditional_t<ConstIter, const FullyTypedFieldMap,
                                            FullyTypedFieldMap>;
      ...
      //! constructor
      inline iterator(TypedMap_t & fieldmap, bool begin = true);
    ...
    class FieldMap<FieldCollection, T, NbComponents, ConstField>::enumerator {
     public:
      //! fully typed reference as seen by the iterator
      using TypedMap_t = typename Iterator::TypedMap_t;

      //! Default constructor
      enumerator() = delete;

      //! constructor with field mapped
      enumerator(TypedMap_t & field_map) : field_map{field_map} {}
  ...
  namespace internal {
    ...
    FieldMap<FieldCollection, T, NbComponents, ConstField>::iterator<
        FullyTypedFieldMap, ConstIter>::iterator(TypedMap_t & fieldmap,
                                                 bool begin)
