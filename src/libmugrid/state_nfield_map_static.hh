...
namespace muGrid {
  ...
  /**
   * statically sized version of `muGrid::TypedStateNField`. Duplicates its
  ...
  class StaticStateNFieldMap : public StateNFieldMap<T, Mutability> {
   ...
   public:
     ...
     * handled by the `muGrid::StaticStateNFieldMap::StateWrapper`, a
  ...
  /**
   * Alias of `muGrid::StaticStateNFieldMap` you wish to iterate over pixel by
  ...
  /**
   * Alias of `muGrid::StaticStateNFieldMap` over a scalar field you wish to
  ...
  /**
   * Alias of `muGrid::StaticStateNFieldMap` over a fourth-rank tensor field you
   * wish to iterate over quadrature point by quadrature point.
   *
   * @tparam T scalar type stored in the field, must be one of `muGrid::Real`,
   * `muGrid::Int`, `muGrid::Uint`, `muGrid::Complex`
