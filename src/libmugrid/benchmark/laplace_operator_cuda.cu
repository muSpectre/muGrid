/**
 * @file   laplace_operator_cuda.cu
 *
 * @author Lars Pastewka <lars.pastewka@imtek.uni-freiburg.de>
 *
 * @date   24 Dec 2024
 *
 * @brief  CUDA implementation of hard-coded Laplace operators
 *
...
/**
 * CUDA kernel for 2D Laplace operator with 5-point stencil.
 */
...
/**
 * CUDA kernel for 3D Laplace operator with 7-point stencil.
 */
