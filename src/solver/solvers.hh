...
namespace muSpectre {
  ...
  newton_cg (CellBase<DimS, DimM> & sys,
  ...
  newton_cg (CellBase<DimS, DimM> & sys, const Grad_t<DimM> & delF0,
             SolverBase<DimS, DimM> & solver, Real newton_tol,
             Real equil_tol,
             Dim_t verbose = 0){
  ...
  template <Dim_t DimS, Dim_t DimM=DimS>
  std::vector<OptimizeResult>
  de_geus (CellBase<DimS, DimM> & sys,
           const GradIncrements<DimM> & delF0,
           SolverBase<DimS, DimM> & solver, Real newton_tol,
           Real equil_tol,
           Dim_t verbose = 0);
  ...
  template <Dim_t DimS, Dim_t DimM=DimS>
  OptimizeResult
  de_geus (CellBase<DimS, DimM> & sys, const Grad_t<DimM> & delF0,
           SolverBase<DimS, DimM> & solver, Real newton_tol,
           Real equil_tol,
           Dim_t verbose = 0){
