...
The latter option requires you to have a user account on c4science (`create
<https://c4science.ch/auth/start/>`_).
...
to pick up the `task <https://c4science.ch/T1852>`_.
...
*µ*\Spectre is in a very early stage of development and the documentation is
 ...
 please contact us on the `µSpectre chat room <https://c4science.ch/Z69>`_ and
 someone will answer as soon as possible. You can also check the API
 :ref:`reference`.
...
<https://c4science.ch/project/board/1447/>`_ and assign it to user
...
be documented and have unit tests. Please submit contributions for review as
`Arcanist revisions
<https://secure.phabricator.com/book/phabricator/article/arcanist/>`_. More
