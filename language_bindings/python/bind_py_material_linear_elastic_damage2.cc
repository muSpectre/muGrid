/**
 * @file   bind_py_material_linear_elastic_damage2.cc
 *
 * @author Ali Falsafi <ali.falsafi@epfl.ch>
 *
 * @date   04 May 2020
 *
 * @brief  python bindings for MaterailLinearElasticDamage2
 *
...
void add_material_linear_elastic_damage2_helper(py::module & mod) {
  ...
  name_stream << "MaterialLinearElasticDamage2_" << Dim << "d";
  const auto name{name_stream.str()};

  using Mat_t = muSpectre::MaterialLinearElasticDamage2<Dim>;
...
template void
add_material_linear_elastic_damage2_helper<muSpectre::twoD>(py::module &);
template void
add_material_linear_elastic_damage2_helper<muSpectre::threeD>(py::module &);
