/**
 * @file   bind_py_material_hyper_elastic1.cc
 *
 * @author Indre Joedicke <indre.joedicke@imtek.uni-freiburg.de>
 *
 * @date   18 Oct 2021
 *
 * @brief  python bindings for MaterialHyperElastic1
 *
...
void add_material_hyper_elastic1_helper(py::module & mod) {
  ...
  name_stream << "MaterialHyperElastic1_" << dim << 'd';
  const auto name{name_stream.str()};

  using Mat_t = muSpectre::MaterialHyperElastic1<dim>;
...
template void
add_material_hyper_elastic1_helper<muSpectre::twoD>(py::module &);
template void
add_material_hyper_elastic1_helper<muSpectre::threeD>(py::module &);
