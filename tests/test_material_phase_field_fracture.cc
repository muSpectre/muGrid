...
namespace muSpectre {
  ...
  using mats = boost::mpl::list<MaterialFixture<twoD>,
      MaterialFixture<threeD>>;
  ...
  BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_add_pixel, Fix, mats, Fix) {
    ...
    for (Dim_t i = 0; i < nb_pixel; ++i) {
      ...
      BOOST_CHECK_NO_THROW(mat.add_pixel(c, Fix::Youngs_modulus,
          Fix::Poisson_ratio, Fix::phi));
    }
  }
  ...
  using mats_zero_phi = boost::mpl::list<
      MaterialZeroPhi<twoD, false, false>,
      MaterialZeroPhi<twoD, false, true>,
      MaterialZeroPhi<twoD, true, false>,
      MaterialZeroPhi<twoD, true, true>,
  ...
  BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_zero_phi, Fix, mats_zero_phi, Fix) {
    ...
    Real lambda = Hooke::compute_lambda(Fix::Youngs_modulus,
        Fix::Poisson_ratio);
    ...
    Strain_t stress{};
    std::tie(stress, stress_tangent) = mat.evaluate_stress_tangent(E,
        lambda, mu, Fix::phi, Fix::ksmall);
    Strain_t stress_2nd_fn{mat.evaluate_stress(E, lambda, mu, Fix::phi,
        Fix::ksmall)};
  ...
  using mats_biaxial = boost::mpl::list<MaterialBiaxial<twoD, false>,
                                     MaterialBiaxial<twoD, true>,
                                     MaterialBiaxial<threeD, false>,
                                     MaterialBiaxial<threeD, true>>;
  ...
  using mats_reference_no_poisson = boost::mpl::list<
      MaterialReferenceNoPoisson<twoD>,
  ...
  BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_reference_no_poisson, Fix,
    ...
    if (Dim == 2) {
      ...
      temp << 372.94683683, -132.11550336,
          -132.11550336, 17.85344640,
          -132.11550336, 301.09254430,
          301.09254430, -160.68101760,
          -132.11550336, 301.09254430,
          301.09254430, -160.68101760,
          17.85344640, -160.68101760,
          -160.68101760, 841.42127037;
    } else {
      E << 0.001,  0.001,   0.0,
           0.001, -0.0005, -0.0008,
           0.0,   -0.0008, -0.0012;
      if (Fix::is_compression) {
        temp << 371.37922461, -129.54246894, -0.65953777,
            -129.54246894, 47.75065469, -34.98597465,
            -0.65953777, -34.98597465, 16.31350467,
            -129.54246894, 306.98560646, 35.04949180,
            306.98560646, -173.17967126, 38.76862047,
            35.04949180, 38.76862047, -7.90093056,
            -0.65953777, 35.04949180, 336.82948958,
            35.04949180, 38.76862047, -95.44526361,
            336.82948958, -95.44526361, 52.24718707,
            -129.54246894, 306.98560646, 35.04949180,
            306.98560646, -173.17967126, 38.76862047,
            35.04949180, 38.76862047, -7.90093056,
            47.75065469, -173.17967126, 38.76862047,
            -173.17967126, 794.97516875, 53.25277198,
            38.76862047, 53.25277198, -13.63284915,
            -34.98597465, 38.76862047, -95.44526361,
            38.76862047, 53.25277198, 438.19963534,
            -95.44526361, 438.19963534, 31.44786578,
            -0.65953777, 35.04949180, 336.82948958,
            35.04949180, 38.76862047, -95.44526361,
            336.82948958, -95.44526361, 52.24718707,
            -34.98597465, 38.76862047, -95.44526361,
            38.76862047, 53.25277198, 438.19963534,
            -95.44526361, 438.19963534, 31.44786578,
            16.31350467, -7.90093056, 52.24718707,
            -7.90093056, -13.63284915, 31.44786578,
            52.24718707, 31.44786578, 982.85798622;
      } else {
        E = -E;
        temp << 878.69577539, 129.54246894, 0.65953777,
            129.54246894, -47.75065469, 34.98597465,
            0.65953777, 34.98597465, -16.31350467,
            129.54246894, 318.05189354, -35.04949180,
            318.05189354, 173.17967126, -38.76862047,
            -35.04949180, -38.76862047, 7.90093056,
            0.65953777, -35.04949180, 288.20801042,
            -35.04949180, -38.76862047, 95.44526361,
            288.20801042, 95.44526361, -52.24718707,
            129.54246894, 318.05189354, -35.04949180,
            318.05189354, 173.17967126, -38.76862047,
            -35.04949180, -38.76862047, 7.90093056,
            -47.75065469, 173.17967126, -38.76862047,
            173.17967126, 455.09983125, -53.25277198,
            -38.76862047, -53.25277198, 13.63284915,
            34.98597465, -38.76862047, 95.44526361,
            -38.76862047, -53.25277198, 186.83786466,
            95.44526361, 186.83786466, -31.44786578,
            0.65953777, -35.04949180, 288.20801042,
            -35.04949180, -38.76862047, 95.44526361,
            288.20801042, 95.44526361, -52.24718707,
            34.98597465, -38.76862047, 95.44526361,
            ...
            -16.31350467, 7.90093056, -52.24718707,
            7.90093056, 13.63284915, -31.44786578,
            -52.24718707, -31.44786578, 267.21701378;
      }
    }
  ...
  using mats_reference = boost::mpl::list<MaterialReference<twoD>,
      MaterialReference<threeD>, MaterialReference<threeD, false>>;

  BOOST_FIXTURE_TEST_CASE_TEMPLATE(test_reference, Fix,
      mats_reference, Fix) {
    constexpr Dim_t Dim{Fix::mdim()};
    using Strain_t = Eigen::Matrix<Real, Dim, Dim>;
    using Stiffness_t = muGrid::T4Mat<Real, Dim>;
    ...
    if (Dim == 2) {
      E << 0.001, 0.001, 0.001, -0.0006;
      temp << 431.15622064, -101.62731028,
          -101.62731028, 158.00745877,
          -101.62731028, 231.60964946,
          231.60964946, -123.60078277,
          -101.62731028, 231.60964946,
          231.60964946, -123.60078277,
          158.00745877, -123.60078277,
          -123.60078277, 791.52116951;
    } else {
      E << 0.001,  0.001,   0.0,
           0.001, -0.0005, -0.0008,
           0.0,   -0.0008, -0.0012;
      if (Fix::is_compression) {
        temp << 862.59940354, -99.64805303, -0.50733674,
            -99.64805303, 613.65434976, -26.91228819,
            -0.50733674, -26.91228819, 589.47192667,
            -99.64805303, 236.14277420, 26.96114754,
            236.14277420, -133.21513174, 29.82201574,
            26.96114754, 29.82201574, -6.07763889,
            -0.50733674, 26.96114754, 259.09960737,
            26.96114754, 29.82201574, -73.41943355,
            259.09960737, -73.41943355, 40.19014390,
            -99.64805303, 236.14277420, 26.96114754,
            236.14277420, -133.21513174, 29.82201574,
            26.96114754, 29.82201574, -6.07763889,
            613.65434976, -133.21513174, 29.82201574,
            -133.21513174, 1188.44243750, 40.96367076,
            29.82201574, 40.96367076, 566.43626988,
            -26.91228819, 29.82201574, -73.41943355,
            29.82201574, 40.96367076, 337.07664257,
            -73.41943355, 337.07664257, 24.19066599,
            -0.50733674, 26.96114754, 259.09960737,
            26.96114754, 29.82201574, -73.41943355,
            259.09960737, -73.41943355, 40.19014390,
            -26.91228819, 29.82201574, -73.41943355,
            29.82201574, 40.96367076, 337.07664257,
            -73.41943355, 337.07664257, 24.19066599,
            589.47192667, -6.07763889, 40.19014390,
            -6.07763889, 566.43626988, 24.19066599,
            40.19014390, 24.19066599, 1332.96768170;
      } else {
        E = -E;
        temp << 820.19386569, 99.64805303, 0.50733674,
            99.64805303, 107.54276562, 26.91228819,
            0.50733674, 26.91228819, 131.72518872,
            99.64805303, 244.65530272, -26.96114754,
            244.65530272, 133.21513174, -29.82201574,
            -26.96114754, -29.82201574, 6.07763889,
            0.50733674, -26.96114754, 221.69846956,
            -26.96114754, -29.82201574, 73.41943355,
            221.69846956, 73.41943355, -40.19014390,
            99.64805303, 244.65530272, -26.96114754,
            244.65530272, 133.21513174, -29.82201574,
            -26.96114754, -29.82201574, 6.07763889,
            107.54276562, 133.21513174, -29.82201574,
            133.21513174, 494.35083173, -40.96367076,
            -29.82201574, -40.96367076, 154.76084550,
            26.91228819, -29.82201574, 73.41943355,
            -29.82201574, -40.96367076, 143.72143436,
            73.41943355, 143.72143436, -24.19066599,
            0.50733674, -26.96114754, 221.69846956,
            -26.96114754, -29.82201574, 73.41943355,
            221.69846956, 73.41943355, -40.19014390,
            26.91228819, -29.82201574, 73.41943355,
            -29.82201574, -40.96367076, 143.72143436,
            73.41943355, 143.72143436, -24.19066599,
            131.72518872, 6.07763889, -40.19014390,
            6.07763889, 154.76084550, -24.19066599,
            -40.19014390, -24.19066599, 349.82558753;
      }
    }
    Stiffness_t C_ref{muGrid::testGoodies::from_numpy(temp)};
    using Hooke = MatTB::Hooke<Dim, Strain_t, Stiffness_t>;
