...
# -*- coding:utf-8 -*-
"""
@file   python_fem_trust_region_newton_pcg_solver_test.py
...
class FEMTRSolverClassCheck(unittest.TestCase):
    def setUp(self):
        ...
        self.fem_stencil = msp.FEMStencil.linear_triangle(
            self.cell)
    ...
    def test_solve_fem(self):
        ...
        krylov_solver = msp.solvers.KrylovSolverTrustRegionPCG(
            cg_tol, maxiter, self.trust_radius, verbose)

        newton_solver = msp.solvers.SolverFEMTRNewtonPCG(
        ...
        reference_material = newton_solver.tangent.map.mean()
        newton_solver.set_reference_material(reference_material)
