...
# -*- coding:utf-8 -*-
"""
@file   python_material_phase_field_fracture2_test.py
...
def test_tangent_worker(testobj, dim):
    ...
    if (dim == 2):
        mat = µ.material.MaterialPhaseFieldFracture2_2d.make(
            cell, "material_small", ksmall)
    else:
        mat = µ.material.MaterialPhaseFieldFracture2_3d.make(
            cell, "material_small", ksmall)
...
class MaterialPhaseFieldFracture2_Check(unittest.TestCase):
    def setUp(self):
