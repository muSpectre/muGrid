...
The [Benchmark](benchmark.md) page reports CPU and GPU timings across a range of
grid sizes, together with the hardware they were run on. It is generated by
`examples/benchmark.py` (re-run it to refresh the numbers for your own hardware).
