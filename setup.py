...
sources = ['language_bindings/libmufft/python/bind_py_module.cc',
           ...
           'src/libmugrid/nfield.cc',
           'src/libmugrid/nfield_typed.cc',
           'src/libmugrid/nfield_map.cc',
           'src/libmugrid/state_nfield.cc',
           'src/libmugrid/state_nfield_map.cc',
           'src/libmugrid/nfield_collection.cc',
           'src/libmugrid/nfield_collection_global.cc',
           'src/libmugrid/nfield_collection_local.cc',
