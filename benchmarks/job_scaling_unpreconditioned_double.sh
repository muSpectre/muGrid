#!/bin/bash
#SBATCH --job-name=muGrid-homog-scaling-none-fp64
...
# job_scaling_unpreconditioned_single.sh; both append to the same DB and the
# docs overlay the two precisions.
#
...
echo "=== Case 2: unpreconditioned scaling, fp64 (solve time vs grid size) ==="
