#!/bin/bash
#SBATCH --job-name=muGrid-homog-scaling-ref-fp64
...
# job_scaling_preconditioned_single.sh; both append to the same DB and the docs
...
# the FFT-engine paths (native N-D transform on the GPU, slab MPI decomposition).
#
...
echo "=== Case 3: reference-preconditioned scaling, fp64 (time vs grid size) ==="
